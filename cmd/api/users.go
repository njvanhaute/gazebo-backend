...
func (app *application) getUsersInBandHandler(w http.ResponseWriter, r *http.Request) {
...
func (app *application) getBandsJoinedByUserHandler(w http.ResponseWriter, r *http.Request) {
	...
	bands, err := app.models.BandMembers.GetAllBandsForUser(userID)
	if err != nil {
		switch {
		case errors.Is(err, data.ErrRecordNotFound):
			app.notFoundResponse(w, r)
